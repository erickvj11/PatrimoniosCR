<html lang="en">
  ...
  <body>
    ...
    <header>
        <div>COSTA RICA ARQUITÉCTONICA?</div>      
    </header>

    <!-- Page Content -->
    <section class="py-5">
      <div class="container">
        <h1 class="my-4">¿Porqué
        <small>Costa Rica Arquitectónica?</small>
      </h1>
      <hr>    
      </div>
      
      <div class="container">
        <h1 class = "my-3">OBJETIVO</h1>
        <p>La Organización tiene como fin general promover el estudio, la conservación y la puesta en valor del patrimonio histórico-cultural nacional, en especial el histórico-arquitectónico.</p>
        <hr>
      </div>
